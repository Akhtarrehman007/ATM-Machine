...
if (InsertATM && answers.pin === PinCode) {
    ...
    if (correctpin.actions === "Account Information") {
        ...
        console.log(chalk.green(`Cash Deposited ,Your Balance is: ${PresentBalance}`)); //homework given to use string interpolation.
    }
        ...
        let withdraw = await inquirer.prompt([
            {
                name: "withdraw_money",
                type: "number",
                message: chalk.yellowBright("Enter The Amount Which You Want To Withdraw"),
            },
        ]);
    ...
    //homework
        ...
        console.log(chalk.redBright(`You Withdraw Money As Fast Cash, Successfully ${fastcash.f_cash}`));
        console.log(chalk.green(`Now, your Remaining Balance is ${PresentBalance}`));
    }
    ...
    console.log(chalk.bgYellow.redBright("Please Enter Your Correct 4-Digit PinCode"));
}
